	...
	<body id="page-top">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <img class="masthead-avatar mb-5" src="assets/img/motologo.png" alt="" />
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">Juegas como la Moto</h1>
                <!-- Icon Divider-->
...
if(!$link){
    ...
    if(!$base){
      ...
      //Sentencia SQL
      $sql= "UPDATE `roles` SET `saldo`= ".$total3." WHERE `id_jugador`= 2";
      $ejecuta_sentencia = mysqli_query($link, $sql);
