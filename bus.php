	...
	<body id="page-top">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <img class="masthead-avatar mb-5" src="assets/img/buslogo.png" alt="" />
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">Juegas como el Bus</h1>
                <!-- Icon Divider-->
...
if(!$link){
    ...
    if(!$base){
      ...
      //Sentencia SQL
      $sql= "UPDATE `roles` SET `saldo`= ".$total3." WHERE `id_jugador`= 3";
      $ejecuta_sentencia = mysqli_query($link, $sql);
